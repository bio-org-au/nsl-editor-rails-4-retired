...
class ForMullerWithUmlautTest < ActiveSupport::TestCase
  ...
  test "simple search for muller with umlaut using umlaut" do
    results, rejected_pairings,is_limited,focus_anchor_id,info = Author::AsSearchEngine.search("fr.müLl.")
  ...
  test "simple search for muller with umlaut using u" do
    results, rejected_pairings,is_limited,focus_anchor_id,info = Author::AsSearchEngine.search("fr.muLl.")
    assert_equal results.class, Author::ActiveRecord_Relation, "Results should be a Author::ActiveRecord_Relation."
