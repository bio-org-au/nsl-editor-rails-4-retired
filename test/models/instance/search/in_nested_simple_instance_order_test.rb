...
class InNestedSimpleInstanceOrderTest < ActiveSupport::TestCase
  ...
  test "instances in nested simple instance order" do
    ...
    assert_with_args(results,25,"74, t. 100 - a_subclassis")
    assert_with_args(results,26,"999 - a_subfamily")
    assert_with_args(results,27,"999 - a_subordo")
    assert_with_args(results,28,"999 - a_subtribus")
    assert_with_args(results,29,"74, t. 99 - a_superordo")
    assert_with_args(results,30,"999 - a_tribus")
