...
class InNestedSimpleInstanceOrderTest < ActiveSupport::TestCase
  ...
  test "instances in nested simple instance order" do
    ...
    assert_with_args(results,4,"zzzz99901 - Casuarina inophloia F.Muell. & F.M.Bailey")
    assert_with_args(results,5,"zzzz99902 - Casuarina inophloia F.Muell. & F.M.Bailey")
