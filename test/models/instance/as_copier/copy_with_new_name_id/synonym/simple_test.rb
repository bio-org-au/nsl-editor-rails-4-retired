...
class InstanceAsCopierCopySynonymWithNewNameIdTest < ActiveSupport::TestCase
  ...
  # master_instance = Instance::AsCopier.find(instances(
  #   :metrosideros_costata_is_basionym_of_angophora_costata).id)
  ...
  # assert_equal before_for_name + 1, after_for_name, "There should be one \
  # extra instance attached to the target name."
