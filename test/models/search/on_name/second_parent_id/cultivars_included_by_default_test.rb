...
class SearchOnName2ndParentIdCultivarsIncludedByDefaultTest < ActiveSupport::TestCase
  test "search on name second parent id cultivars included by default" do
    ...
    assert_equal 1, search.executed_query.results.size,
                 "Expected cultivar name to be included by default for second parent id query"
  end
end
