...
class SearchParseQueryCountAngophoraCostataTest < ActiveSupport::TestCase
  ...
  test "search parse query count angophora costata" do
    ...
    assert_match /\Aangophora costata\z/, parsed_query.where_arguments, "The where args '#{parsed_query.where_arguments}' should match /\\Aangophora costata\\z/."
  end
