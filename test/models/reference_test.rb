...
class ReferenceTest < ActiveSupport::TestCase
  ...
  # test "update title for citation:book:orphan:no year:no pubdate:1:" do
  #   ref =
  #   references(:orphan_book_edited_by_brassard_no_year_no_publication_date)
  #   ref.title = 'New Title'
  #   try_citation(ref,
  ...
  #                'citation wrong for section with same author as parent')
  # end

  # test "citation:sect:par:par auth different:par author role is author:3:" do
  #   try_citation(
  #   references(:section_with_heyland_author_different_from_parent),
  #                'Heyland [y] in Brassard [x], book by brassard.',
  #                'citation wrong 4 section with different author from parent')
  # end

  # test "cit:sect:parent:parent author different:parent author is editor:4:" do
  #   try_citation(
  #   references(:section_with_heyland_author_different_from_parent_editor),
  ...
  #                "Brassard [x] in Blume, C.L. [von], (ed.) (1690) paper
  #                within journal. journal with papers Edn. 1, 2.",
  #                'citation not set correctly')
  # end

  # test "cit:paper:author brassard:no parent:no year:no publication date:6:" do
  # try_citation(
  # references(:paper_with_no_parent_no_year_no_publication_date),
  ...
  #   try_citation(
  #   references(:orphan_book_edited_by_brassard_no_year_no_publication_date),
  #   'Brassard [x], (ed.) Orphan book edited by brassard no year
  #   no publication date.',
  #   'book citation wrong')
  # end
  ...
  #   try_citation(
  #   references(:orphan_book_edited_by_brassard_with_year_no_publication_date),
  #   'Brassard [x], (ed.) (1797) Orphan book edited by brassard with year
  ...
  # try_citation(
  # references(:orphan_book_edited_by_brassard_with_year_and_publication_date),
  # 'Brassard [x], (ed.) (1790) Orphan book edited by brassard with year
  ...
  # try_citation(
  # references(:orphan_book_edited_by_brassard_with_no_year_but_publication_date),
  # 'Brassard [x], (ed.) (1870) Orphan book edited by brassard with
  # no year but publication date.',
  # 'book citation wrong')
  # end

  # test "cit:book:orphan:title is not set: no year: no publication date:11:" do
  ...
  #   try_citation(
  #   references(:orphan_book_by_blume_c_l_von),
  ...
  # # Note: this test is passing because it allows for the extra
  # 3 space in the title to be removed.
  # # TODO: discuss with users - is that ok?
  # test "book:extra space in title:14:" do
  #   try_citation(
  #   references(:book_with_extra_space_in_title),
  ...
  #   try_citation(
  #   references(:book_with_ellipses_in_title),
  #   'Brassard [x], (1799) book... with ellipses in title...',
  #   'book citation wrong for ellipses in title (perhaps)')
  # end

  # test "cit:paper:with par:yr 1690:auth brassard:pap title has stop:15:" do
  #   try_citation(
  #   references(:paper_within_journal_title_has_full_stop),
  #   'Brassard [x] in Blume, C.L. [von], (ed.) (1690) paper within
  #   journal title has full stop. journal with papers Edn. 1, 2.',
  #   'citation not set correctly')
  # end

  # test "paper:extra space in title:16:" do
  #   try_citation(
  #   references(:paper_with_extra_space_in_title),
  #   'Brassard [x] in Blume, C.L. [von], (ed.) (1690) paper
  #   with extra space in title. journal with papers Edn. 1, 2.',
  #   'paper citation wrong for extra space in title (perhaps)')
  # end

  # test "cit:unknown:title not set:parent journal:parent author same:17:" do
  #   try_citation(references(:unknown_in_journal_with_hooker_author_of_both),
  #                'Hooker, W.J., (1690) botanical magazine Edn. 1, 2.',
  #                'wrong citation for unknown with same author as parent')
  # end

  # test "cit:unkn:title not set:parent journal:parent author name dash:18:" do
  #   try_citation(
  #   references(:burbidge_1946_JRSWA30),
  #   'Burbidge, N.T. in (1946) journal of the royal
  #   society of western australia 30.',
  #   'citation not set correctly')
  # end
  # # Burbidge, N.T., (1946) Journal of the Royal
  # Society of Western Australia 30

  # test "citation:sturm:Enumerato Plantarum:198:" do
  #   try_citation(
  #   references(:sturm_enumerato_plantarum),
  #   'Sturm, J.W., (1858) Enumeratio Plantarum Vascularum Cryptogamicarum
  #   Chilensium',
  #                'citation not set correctly')
  # end
  # # Burbidge, N.T., (1946) Journal of the Royal Society of Western
  # Australia 30
