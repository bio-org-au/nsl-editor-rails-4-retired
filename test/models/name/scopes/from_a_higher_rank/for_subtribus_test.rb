...
class ForSubtribusTest < ActiveSupport::TestCase
  test "from a higher rank for subtribus" do
    ranks = Name.from_a_higher_rank(name_ranks(:subtribus).id).collect { |name| name.name_rank.name }.uniq
