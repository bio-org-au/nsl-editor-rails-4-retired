...
class ForSubspeciesTest < ActiveSupport::TestCase
  test "from a higher rank for subspecies" do
    ranks = Name.from_a_higher_rank(name_ranks(:subspecies).id).collect { |name| name.name_rank.name }.uniq
