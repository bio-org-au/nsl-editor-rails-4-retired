...
class InstanceTypeSynonymOptionsTest < ActiveSupport::TestCase
  test 'instance type synonym options' do
    ...
    assert names.include?('doubtful pro parte misapplied'), 'Should include doubtful pro parte misapplied'
    assert_not names.include?('doubtful pro parte synonym'), 'Should not include doubtful pro parte synonym'
    assert names.include?('doubtful pro parte taxonomic synonym'), 'Should include doubtful pro parte taxonomic synonym'
    assert_not names.include?('doubtful synonym'), 'Should not include doubtful synonym'
    assert names.include?('doubtful taxonomic synonym'), 'Should include doubtful taxonomic synonym'
    assert names.include?('isonym'), 'Should include isonym'
    assert names.include?('misapplied'), 'Should include misapplied'
    assert names.include?('nomenclatural synonym'), 'Should include nomenclatural synonym'
    assert names.include?('orthographic variant'), 'Should include orthographic variant'
    assert names.include?('pro parte misapplied'), 'Should include pro parte misapplied'
    assert_not names.include?('pro parte synonym'), 'Should not include pro parte synonym'
    assert names.include?('pro parte taxonomic synonym'), 'Should include pro parte taxonomic synonym'
    ...
    assert names.include?('taxonomic synonym'), 'Should include taxonomic synonym'
    ...
    assert_not names.include?('comb. et nom. nov.'), 'Should not include comb. et nom. nov.'
    assert_not names.include?('comb. et stat. nov.'), 'Should not include comb. et stat. nov.'
    assert_not names.include?('comb. nov.'), 'Should not include comb. nov.'
    assert_not names.include?('doubtful invalid publication'), 'Should not include doubtful invalid publication'
    assert_not names.include?('doubtful nomenclatural synonym'), 'Should not include doubtful nomenclatural synonym'
    assert_not names.include?('excluded name'), 'Should not include excluded name'
    assert_not names.include?('homonym'), 'Should not include homonym'
    assert_not names.include?('implicit autonym'), 'Should not include implicit autonym'
    assert_not names.include?('invalid publication'), 'Should not include invalid publication'
    assert_not names.include?('nom. et stat. nov.'), 'Should not include nom. et stat. nov.'
    assert_not names.include?('nom. nov.'), 'Should not include nom. nov.'
    assert_not names.include?('primary reference'), 'Should not include primary reference'
    assert_not names.include?('pro parte nomenclatural synonym'), 'Should not include pro parte nomenclatural synonym'
    assert_not names.include?('pro parte replaced synonym'), 'Should not include pro parte replaced synonym'
    assert_not names.include?('secondary reference'), 'Should not include secondary reference'
