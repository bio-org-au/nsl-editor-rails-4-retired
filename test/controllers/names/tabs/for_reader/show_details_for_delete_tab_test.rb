...
class NameShowDetailsInsteadOfDeleteTabForReadOnlyTest < ActionController::TestCase
  tests NamesController
  setup do
    @name = names(:a_species)
  end

  test "should show details tab if reader requests delete tab" do
    ...
    assert_select 'li a#name-delete-tab', false, "Should not show 'Delete' tab at all."
