...
class ReaderNewSearchControllerNamesNameRankMultipleValuesListTest < ActionController::TestCase
  ...
  test "reader can search for a name by rank with multiple values" do
    ...
    forma = names(:a_forma)
    get(:search,{search_from: 'string', query_string: 'name-rank: tribus,subgenus,forma'},{username: 'fred', user_full_name: 'Fred Jones', groups: []})
