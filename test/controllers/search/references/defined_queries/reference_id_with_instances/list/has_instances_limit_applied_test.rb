...
class SearchReferencesDefinedQueriesReferenceIdWithInstancesListHasInstancesLimitAppliesTest < ActionController::TestCase
  tests SearchController
  
  test "reference id with instances limited" do
    ref = references(:bucket_reference_for_default_instances)
    get(:search,{query_target: 'instances for ref id', query_string: "#{ref.id} limit:10"},{username: 'fred', user_full_name: 'Fred Jones', groups: []})
