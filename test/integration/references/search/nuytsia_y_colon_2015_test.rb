...
class NuytsiaYColon2015Test < ActionDispatch::IntegrationTest
  # Make the Capybara DSL available in all integration tests
  include Capybara::DSL

  test "reference search for Nuytsia y colon 2015" do
    visit_home_page
    standard_page_assertions
    select "Reference", from: "query-on"
    fill_in "search-field", with: "Nuytsia y:2015"
    click_button "Search"
    sleep(0.1)
    ...
    # Nuytsia. 25 : 31-37"
    # search_result_must_include(string)
  end
end
