...
class AvailableFieldsTest < ActionDispatch::IntegrationTest
  ...
  test 'reference available fields' do
    ...
    assert page.has_field?('reference-parent-typeahead'), '#reference-parent-typeahead missing'
    assert page.has_field?('reference_title'), '#reference_title missing'
    assert page.has_field?('reference_published'), '#reference_published missing'
    assert page.has_field?('reference-author-typeahead'), '#reference-author-typeahead missing'
    assert page.has_field?('reference_ref_author_role_id'), '#reference_ref_author_role_id missing'
