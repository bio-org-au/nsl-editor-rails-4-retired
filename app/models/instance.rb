...
class Instance < ActiveRecord::Base
  ...
  def relationship_ref_must_match_cited_by_instance_ref
    errors.add(:reference_id, "must match cited by instance reference") if self.relationship? && !(reference.id == this_is_cited_by.reference.id)
  end
  ...
  def synonymy_name_must_match_cites_instance_name
    errors.add(:name_id, "must match cites instance name") unless !self.synonymy? || name.id == this_cites.name.id
  end
  ...
  def cannot_cite_itself
    errors[:base] << "cannot cite itself" unless !self.synonymy? || id != cites_id
  end

  def cannot_be_cited_by_itself
    errors.add(:name_id, "cannot be cited by itself") unless !self.relationship? || id != cited_by_id
  end

  def synonymy_must_keep_cites_id
    errors.add(:cites_id, "cannot be removed once saved") unless cites_id.present? || Instance.find(id).cites_id.nil? || data_fix_in_process
  end
  ...
  def self.consume_token(search_string, requested_token)
    ...
    [!found_token.blank?, search_string.gsub(/#{requested_token.downcase}:/, "")]
  end
  ...
  def self.ref_instances(search_string, limit = 100)
    logger.debug(%(ref_instances search for "#{search_string}" with limit: #{limit}))
    results = []
  ...
  def self.name_instances(name_search_string, limit = 100, apply_limit = true)
    logger.debug(%(-- Name.name_instances search for "#{name_search_string}" with limit: #{limit}))
    names = []
    results = []
    names,
        rejected_pairings,
  ...
  def self.nsl_720
    ...
    results = Instance.where("id in (?) ", [3_593_450, 3_455_690, 3_455_747, 3_587_295, 3_534_663, 3_454_920, 3_454_936, 3_536_329, 3_456_370, 3_454_931,
                                            3_454_850, 3_454_945, 3_498_251, 3_454_966, 3_456_380, 3_480_899, 3_524_687, 3_456_385, 3_458_910, 3_454_921,
                                            3_454_961, 3_526_347, 3_456_333, 3_506_487, 3_455_711, 3_508_136, 3_454_956, 3_455_757, 3_454_975, 3_456_353,
                                            3_454_976, 3_545_422, 3_489_094, 3_456_371, 3_456_350, 3_509_786, 3_463_066, 3_547_132, 3_511_437, 3_516_396,
                                            3_503_189, 3_479_256, 3_480_890, 3_548_842, 3_504_839, 3_454_926, 3_513_089, 3_455_691, 3_514_742, 3_480_894,
                                            3_480_902, 3_484_174, 3_454_950, 3_552_262, 3_484_176, 3_454_910, 3_454_896, 3_518_051, 3_484_178, 3_455_692,
                                            3_585_418, 3_454_869, 3_559_102, 3_455_752, 3_485_815, 3_456_351, 3_454_901, 3_482_538, 3_454_895, 3_487_453,
                                            3_503_192, 3_553_972, 3_455_732, 3_555_682, 3_456_373, 3_454_951, 3_529_670, 3_455_742, 3_563_245, 3_490_734,
                                            3_562_028, 3_455_699, 3_519_710, 3_454_911, 3_455_766, 3_492_375, 3_492_378, 3_454_870, 3_518_054, 3_455_729,
                                            3_586_356, 3_455_767, 3_455_702, 3_499_895, 3_455_712, 3_550_552, 3_501_540, 3_519_713, 3_454_867, 3_460_541,
                                            3_531_333, 3_501_543, 3_588_277, 3_454_830, 3_455_730, 3_560_812, 3_456_352, 3_456_372, 3_480_893, 3_557_392,
                                            3_521_370, 3_456_328, 3_523_028, 3_454_868, 3_528_008, 3_454_885, 3_455_731, 3_460_547, 3_455_741, 3_455_689, 3_454_886])
  end
  ...
  def self.show_simple_instance_within_all_synonyms(starting_point_name, instance)
    ...
    Instance.where(cited_by_id: instance.id).each do |cited_by_original_instance|
      next unless cited_by_original_instance.name == starting_point_name
  ...
  def self.show_simple_instance_within_all_unfiltered_synonyms(_starting_point_name, instance)
    results = []
    instance.name.display_as_part_of_concept
    results.push(instance.name)
    instance.display_as_part_of_concept
