...
class Search::Mapper::Extras
  ...
  MAP = {
    ...
    "references/advanced_search/help",
    "name-search-help" =>
    "names/advanced_search/help",
    "name-plus-instances-search-help" =>
    "names/advanced_search/plus_instances/help",
    "author-search-help" =>
    "authors/advanced_search/help",
    "instance-search-help" =>
    "instances/advanced_search/help",
    "instances-for-name-id-search-help" =>
    "instances/advanced_search/for_name_id/help",
    ...
    "tree-search-help" =>
    "trees/advanced_search/help",
    "review-search-help" =>
    "audits/advanced_search/help",
    ...
    "references/advanced_search/examples",
    "name-search-examples" =>
    "names/advanced_search/examples",
    "name-plus-instances-search-examples" =>
    "names/advanced_search/plus_instances/examples",
    "author-search-examples" =>
    "authors/advanced_search/examples",
    "instance-search-examples" =>
    "instances/advanced_search/examples",
    "instances-for-name-id-search-examples" =>
    "instances/advanced_search/for_name_id/examples",
    ...
    "trees/advanced_search/examples",
    "review-search-examples" =>
    "audits/advanced_search/examples",
    ...
    "names/advanced_search/advanced",
    "name-plus-instances-search-advanced" =>
    "names/advanced_search/plus_instances/advanced",
    "reference-search-advanced" =>
    "references/advanced_search/advanced",
    ...
    "author-search-advanced" =>
    "authors/advanced_search/advanced",
    "instance-search-advanced" =>
    "instances/advanced_search/advanced",
    "instances-for-name-id-search-advanced" =>
    "instances/advanced_search/for_name_id/advanced",
    ...
    "trees/advanced_search/advanced",
    "review-search-advanced" =>
    "audits/advanced_search/advanced",
