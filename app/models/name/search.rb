...
class Name::Search
  ...
  def parse_params
    ...
    @parsed_params << %Q( name: "#{@name_search_name}%") if @name_search_name.present?
    @parsed_params << %Q( author-abbrev: "#{@name_search_author_abbrev}") if @name_search_author_abbrev.present?
    @parsed_params << %Q( ex-author-abbrev: "#{@name_search_ex_author_abbrev}") if @name_search_ex_author_abbrev.present?
    @parsed_params << %Q( base-author-abbrev: "#{@name_search_base_author_abbrev}") if @name_search_base_author_abbrev.present?
    @parsed_params << %Q( ex-base-author-abbrev: "#{@name_search_ex_base_author_abbrev}") if @name_search_ex_base_author_abbrev.present?
    @parsed_params << %Q( sanctioning-author-abbrev: "#{@name_search_sanctioning_author_abbrev}") if @name_search_sanctioning_author_abbrev.present?
    @parsed_params << %Q( comments: "#{@name_search_comments}") if @name_search_comments.present?
    @parsed_params << %Q( comments-by: "#{@name_search_comments_by}") if @name_search_comments_by.present?
  end
