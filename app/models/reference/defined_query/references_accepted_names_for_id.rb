...
#   
class Reference::DefinedQuery::ReferencesAcceptedNamesForId 
  ...
  def debug(s)
    tag = "Reference::DefinedQuery::ReferencesAcceptedNamesForId"
  ...
  def run_query(parsed_request)
    ...
    if parsed_request.count
      ...
      query = Reference.where(id: parsed_request.where_arguments)
      results = []
      ...
      query = Reference.where(id: parsed_request.where_arguments).to_a
