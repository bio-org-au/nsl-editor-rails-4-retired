...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "author", force: true do |t|
    ...
    t.index %w(namespace_id source_id source_system), name: "auth_source_index"
  ...
  create_table "name", force: true do |t|
    ...
    t.index %w(namespace_id source_id source_system), name: "name_source_index"
  ...
  create_table "reference", force: true do |t|
    ...
    t.index %w(namespace_id source_id source_system), name: "ref_source_index"
  ...
  create_table "instance", force: true do |t|
    ...
    t.index %w(namespace_id source_id source_system), name: "instance_source_index"
  ...
  create_table "id_mapper", force: true do |t|
    ...
    t.index %w(from_id namespace_id system), name: "id_mapper_from_index"
    t.index %w(to_id from_id), name: "unique_from_id", unique: true
  ...
  create_table "instance_note", force: true do |t|
    ...
    t.index %w(namespace_id source_id source_system), name: "note_source_index"
  ...
  create_table "tree_node", force: true do |t|
    ...
    t.integer "name_id",                 limit: 8
    t.integer "instance_id",             limit: 8
    t.index %w(instance_id tree_arrangement_id), name: "idx_tree_node_instance_id_in"
    t.index ["instance_id"], name: "idx_tree_node_instance_id"
    t.index ["literal"], name: "idx_tree_node_literal"
    t.index %w(name_id tree_arrangement_id), name: "idx_tree_node_name_id_in"
    t.index ["name_id"], name: "idx_tree_node_name_id"
    t.index %w(name_uri_id_part name_uri_ns_part_id tree_arrangement_id), name: "idx_tree_node_name_in"
    t.index %w(name_uri_id_part name_uri_ns_part_id), name: "idx_tree_node_name"
    t.index ["next_node_id"], name: "tree_node_next"
    t.index ["prev_node_id"], name: "tree_node_prev"
    t.index %w(resource_uri_id_part resource_uri_ns_part_id tree_arrangement_id), name: "idx_tree_node_resource_in"
    t.index %w(resource_uri_id_part resource_uri_ns_part_id), name: "idx_tree_node_resource"
    t.index %w(taxon_uri_id_part taxon_uri_ns_part_id tree_arrangement_id), name: "idx_tree_node_taxon_in"
    t.index %w(taxon_uri_id_part taxon_uri_ns_part_id), name: "idx_tree_node_taxon"
  ...
  create_table "tree_link", force: true do |t|
    ...
    t.index %w(supernode_id link_seq), name: "idx_tree_link_seq", unique: true
